...
*	20230302	clean_commondosages	Tidy script
*************************************
...
sort dosageid
merge 1:1 dosageid using "data/prepared/`cohort'/dosage_key.dta", keep(3) nogen
order dosekey
drop dosageid
...
**# Finalise file
keep dosekey prn unitform dosage2
...
save "data/prepared/`cohort'/clean_dosages.dta", replace
